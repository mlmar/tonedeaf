...
export const TracksSummary = (props) => {
        ...
        return (
            <>
                <p className='panel large bold inactive'>
                    <span className='white'> {track?.name}&nbsp; </span> was your number one track
                </p>
                ...
                <div className='flex-col panel'>
                    <div className='stats list'>
                        {tracksInfo?.tracks?.slice(0, 6).map((track, i) => {
                            return (
                                <label className='flex big bold' onClick={onClick} key={i + track.name}>
                                    <span>{i + 1}.</span>
                    ...
                    <Chart className='flex-fill' averages={averages} display={Config.CHART_COLS} />
                </div>
            );
        }
    };
