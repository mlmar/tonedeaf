        ...
        return (
            <>
                <p className="panel large bold inactive">
                    {" "}
                    <span className="white"> {track?.name} </span> was your
                    number one track{" "}
                </p>
            ...
            return (
                <div className="flex-col panel">
                    ...
                    <p className="large bold inactive">
                        {" "}
                        the stats from your top 50 tracks{" "}
                    </p>
